...
class ProductRepositoryTest {
    ...
    void testDeleteIfNotFound() {
        ...
        Iterator<Product> productIterator = productRepository.findAll();
        assertTrue(productIterator.hasNext());
        assertFalse(productRepository.delete("a0f9de46-90b1-437d-a0bf-d0821dde9096"));
        assertTrue(productIterator.hasNext());
    }
    ...
    void testCreateAndEdit() {
        ...
        product.setProductName("Sampo Cap WumWum");
    ...
    void testEditIfNotFound() {
        ...
        assertNull(productRepository.update(dummyProduct));
    ...
    void testEditIfMoreThanOneProduct() {
        ...
        product1.setProductName("Sampo Cap WumWum");
